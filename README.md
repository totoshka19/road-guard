...
- _Дальше по плану:_ Chart.js (графики), GSAP, PWA
...
src/
  ...
  components/ # UI-компоненты
    map/            #   CityMap (MapLibre) + стили слоёв кластеризации
  features/   # cameras / violations (+ stats / filters / playback — далее)
...
- ⏳ Этап 3 — живой поток нарушений + лента событий (следующий)
